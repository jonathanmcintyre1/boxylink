        ...
        <div class="row d-flex justify-content-center text-center">
            <div class="col-md-8 link-content <?= isset($_GET['preview']) ? 'container-disabled-simple' : null ?>">
                ...
                <footer class="link-footer">
                    <div id="link-verified-wrapper" class="my-3 small" style="<?= $data->user->plan_settings->verified && $data->link->settings->display_verified ? null : 'display: none;' ?>">
                        <span><i class="fa fa-fw fa-check-circle fa-1x link-verified"></i> <span style="<?= $data->link->design->text_style ?>"><?= language()->link->biolink->verified ?></span></span>
                    </div>
