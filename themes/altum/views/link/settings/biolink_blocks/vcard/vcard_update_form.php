...
<form name="update_biolink_" method="post" role="form">
    ...
    <div class="form-group">
        <label for="<?= 'vcard_' . $key . '_' . $row->biolink_block_id ?>"><?= language()->create_biolink_vcard_modal->{$key} ?></label>
        <input id="<?= 'vcard_' . $key . '_' . $row->biolink_block_id ?>" type="text" class="form-control" name="<?= $key ?>" value="<?= $row->settings->{$key} ?>" />
    </div>
    <?php endforeach ?>
    ...
    <div class="form-group">
        ...
        <input id="<?= 'vcard_name_' . $row->biolink_block_id ?>" type="text" name="name" class="form-control" value="<?= $row->settings->name ?>" required="required" />
    </div>
